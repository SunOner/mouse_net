...
# Data settings
# Delete previous generated data True or False (use capital letter on first letter of True or False) default is True
Option_delete_prev_data = True
# Generation settings True or False (use capital letter on first letter of True or False) default is True
Option_Generation = True
# Time in seconds to generate data
Option_gen_time = 180
# Visualise generation True or False (use capital letter on first letter of True or False) default is True
Option_gen_visualise = True
# Visualise draw line True or False (use capital letter on first letter of True or False) default is True
Option_gen_visualise_draw_line = True

# Train model settings True or False (use capital letter on first letter of True or False) default is True
Option_train = True
...
# Save every N epoch - how many epochs to save the model periodically
...
# Random screen resolution True or False (use capital letter on first letter of True or False) default is False
...
# Random field of view True or False (use capital letter on first letter of True or False) default is False
...
# Random mouse DPI True or False (use capital letter on first letter of True or False) default is False
...
# Random mouse sensitivity True or False (use capital letter on first letter of True or False) default is False
...
# Testing model settings True or False (use capital letter on first letter of True or False)
